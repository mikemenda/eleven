...
async function main() {
  ...
  if (overallVerdict === PASS) {
    ...
    console.log('  All Phase 1 page read paths have valid data to work with.')
    console.log('  Ready for Phase 3 — import season script.')
  } else if (overallVerdict === WARNING) {
    console.log('  ⚠   WARNINGS PRESENT — REVIEW BEFORE S4')
    console.log('  No blocking failures. The app will function correctly for S1–S3.')
    console.log('  Review warnings above before importing S4 — some may indicate')
    ...
    console.log('  ✗   REPAIR NEEDED BEFORE S4')
    console.log('  At least one blocking failure detected. See FAIL items above.')
    console.log('  Do not import S4 until failures are resolved.')
